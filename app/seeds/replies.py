...
def seed_replies():
    ...
    user_reply1 = Reply(
        user_id=1, comment_id=1, reply="I like your post", time_created=today, time_updated=today)

    user_reply2 = Reply(
        user_id=1, comment_id=2, reply="I like your thought", time_created=day_before, time_updated=day_before)

    user_reply3 = Reply(
        user_id=3, comment_id=1, reply="I like your thought", time_created=day_before2, time_updated=day_before2)
